...
private fun OnboardingScreen(
    ...
    // The input-method picker is a system dialog (no ON_RESUME on dismiss), so poll until
    // activation completes. The loop exits — and stops polling — once fully set up.
